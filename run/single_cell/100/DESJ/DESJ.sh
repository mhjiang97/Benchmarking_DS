Rscript merge.sj.r --sj_dir ~/projects/AS/data/sim/rsem/revision/sim_1/star \
...
~/DESJoutput/Alljunction.filter.list.xls ~/projects/AS/data/sim/rsem/revision/sim_1/star ~/DESJoutput/
