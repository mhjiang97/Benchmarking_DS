...
dir_bam <- "~/projects/AS/data/sim/rsem/novel_junction/star/"
...
gtf <- "~/projects/AS/data/sim/rsem/novel_junction/gencode.v32.annotation.primary_assembly.protein_coding2.trimed_j2.gtf"
gff <- "~/projects/AS/data/sim/rsem/novel_junction/gencode.v32.annotation.protein_coding2.trimed_j2.gff3"
fa <- "~/doc/reference/fa/GRCh38.primary_assembly.genome.fa"
fa_transcript <- "~/projects/AS/data/sim/rsem/novel_junction/gencode.v32.transcripts_j.fa"
genome_version <- "hg38"
...
prefix_index <- "~/projects/AS/analysis/novel_junction/Whippet/index/index"
bam_min_reads <- 4
...
files_genequant <- glue(
  "~/projects/AS/data/sim/rsem/novel_junction/star/sample{1:8}/ReadsPerGene.out.tab"
) %>% setNames(sampleTable$samples)
files_junctionquant <- glue(
  "~/projects/AS/data/sim/rsem/novel_junction/star/sample{1:8}/SJ.out.tab"
) %>% setNames(sampleTable$samples)
anno_suppa <- "~/projects/AS/analysis/novel_junction/SUPPA/"
anno_rmats <- glue("{dir_out}/rMATS/")
anno_miso <- "~/projects/AS/analysis/novel_junction/MISO/index/commonshortest/"
